    ...
    <div className="content" style={{height: "100%"}}>
      <div className="pappagallo-bg" style={{height: "100%"}}>
        ...
        <div className="section">
          <h1 className="flexbox-column w-75">About</h1>   
          <h3 className="flexbox-column w-75" style={{ marginTop: "70px", color: "black", padding: "20px", backgroundColor: "rgba(218, 253, 200, 0.79)", borderRadius: "10px"}}>
